...
router.post(
  "/book-helicopter-seats",
  bookingController.bookHelicopterSeatsWithoutPayment
);

router.post("/irctc/cancel/:id(\\d+)", bookingController.cancelIrctcBooking);
router.post(
  "/irctc/reschedule/:id(\\d+)",
  bookingController.rescheduleIrctcBooking
);

// General booking cancellation and rescheduling routes (for any agent)
// These routes don't require authentication
router.post("/cancel/:id(\\d+)", bookingController.cancelBooking);
router.post("/reschedule/:id(\\d+)", bookingController.rescheduleBooking);

router.post(
  "/helicopter/cancel/:id(\\d+)",
  bookingController.cancelHelicopterBooking
);
router.post(
  "/helicopter/reschedule/:id(\\d+)",
  bookingController.rescheduleHelicopterBooking
);
...
router.post(
  "/complete-booking-discount",
  bookingController.completeBookingWithDiscount
);
